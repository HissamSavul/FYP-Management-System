<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendNotification.aspx.cs" Inherits="DBPROJECT.SendNotification" %>
    ...
    <form id="form1" runat="server" style="font-family: 'Trebuchet MS'; text-align: left; font-size:130%; width: 30%; height: auto; padding: 1% 4%; margin:0 auto; background-color: rgba(0, 0, 0, 0.5); border: 1px solid white; color: rgba(210, 210, 210);">
        <div>
            ...
            <h1 style="text-align: center;"><b>
                &nbsp;Notification to Supervisors</b></h1>
                <hr />
        ...
        Notification
           ...
           <p style="text-align: left">
            <asp:Button width="25%" class="button button2" ID="Button1" runat="server" Text="Notify" OnClick="Button1_Click1"/>
