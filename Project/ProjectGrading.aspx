<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectGrading.aspx.cs" Inherits="DBPROJECT.ProjectGrading" %>
...
<body>
    ...
    <form id="form1" runat="server" style="font-family: 'Trebuchet MS'; text-align: left; font-size:130%; width: 30%; height: auto; padding: 1% 4%; margin:0 auto;  background-color: rgba(0, 0, 0, 0.5); border: 1px solid white; color: rgba(210, 210, 210);">
        ...
        <br /><br />
        Evaluation
            <asp:TextBox ID="TextBox2" runat="server" height="150px"></asp:TextBox>
        <br /><br />
            Grade
            <asp:DropDownList ID="DropDownList1" runat="server" style = "width: 100%; padding: 12px 20px; margin: 8px 0; border: 3px solid #ccc;">
        ...
        <br /><br />
            <asp:Button width="25%" class="button button2" ID="Button1" runat="server" Text="Assign" OnClick="Button1_Click1"/>
