<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PanelMembers-Interface.aspx.cs" Inherits="DBPROJECT.PanelMembers_Interface" %>
    ...
    <form id="form1" runat="server" style="font-family: 'Trebuchet MS'; text-align: left; font-size:130%; width: 30%; height: auto; padding: 1% 4%; margin:0 auto; background-color: rgba(0, 0, 0, 0.5); border: 1px solid white; color: rgba(210, 210, 210);">
        <div>
            <h1 style="margin-top: 50px; text-align: center"><b>
                &nbsp;Panel Member Interface</b></h1>
            <hr />
          
        </div>
        <p style="text-align: center">
            <asp:Button class="button button1" ID="Button1" runat="server"  Text="List All Projects" OnClick="Button1_Click" />
            <br/><br/>
            <asp:Button class="button button1" ID="Button8" runat="server" Text="Assign Grade" OnClick="Button8_Click" />
            <br /><br/>
            ...
            <br /> <br />
            <asp:Button class="button button1 button2" ID="Button9" runat="server" OnClick="Button9_Click" style= Text="Logout" />
        </p>
    </form>
</body>
</html>
